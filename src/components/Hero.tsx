...
const trustBadges = [
  { icon: <ShieldCheck size={16} />, text: 'Global Export Compliant' },
    ...
    <section className={styles.heroSection}>
      ...
      <div className={`container ${styles.heroContent}`}>
        ...
        >
          ...
          <a href="/SVS%20Exporters%20Catalog.pdf" download="SVS Exporters Catalog.pdf" className={`btn btn-outline-white ${styles.btnLarge}`}>Download Catalog 📥</a>
        </motion.div>
